...
export function Register() {
  ...
  return (
    <Box direction="Column" gap="500">
      ...
      <Text align="Center">
        <Link to={getLoginPath(server)}>{t('register.have_account')}</Link>
      </Text>
    </Box>
  );
}
